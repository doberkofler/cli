...
This document provides essential instructions for autonomous agents (like Cursor, GitHub Copilot, or CLI agents) working on the `cli` repository.
...
A modern project built with cli, emphasizing type safety, performance, and best practices.
